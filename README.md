...
- [📊 Zone Types & Analysis](#-zone-types--analysis)
...
## 📊 Zone Types & Analysis <a id="-zone-types--analysis"></a>
...
## 📈 Visualization & Plotting <a id="-visualization--plotting"></a>
...
## 📁 Input/Output Structure <a id="-inputoutput-structure"></a>

### **Input Data Structure**
```
samples/
├── Sample-1-Open-Field-side-by-side/
│   ├── Tracking_RealSpace_1.txt    # Primary tracking data
│   ├── Tracking_RealSpace_2.txt    # Additional session data
│   ├── Stats_1.txt                 # ToxTrac statistics (optional)
│   ├── Distribution_Speed_1.txt    # Speed distributions (optional)
│   └── ...                         # Other ToxTrac outputs
└── Other Experiments/
    └── ...
```
...
```
results/
└── toxtrac_analysis_20250715_100805/    # Timestamped directory
    ├── analysis_results.csv              # Main results table
    ├── analysis_results.json             # Structured data
    └── plots/                            # Visualization directory
        ├── Tracking_RealSpace_1/         # Session-specific plots
        │   ├── Tracking_RealSpace_1_trajectory_zones.png
        │   ├── Tracking_RealSpace_1_trajectory_speed.png
        │   ├── Tracking_RealSpace_1_zone_occupancy.png
        │   ├── Tracking_RealSpace_1_speed_distribution.png
        │   ├── Tracking_RealSpace_1_movement_heatmap.png
        │   └── Tracking_RealSpace_1_timeseries.png
        ├── Tracking_RealSpace_2/         # Second session plots
        │   └── ...
        └── summary/                      # Cross-session analysis
            ├── session_comparison.png
            └── zone_usage_summary.png
```
...
## 🔬 Analysis Results <a id="-analysis-results"></a>
...
- 💡 **Feature Requests**: Suggest new analysis methods or visualizations
- 📝 **Documentation**: Improve documentation and examples
- 🔬 **Code Contributions**: Implement new features or fix bugs
- 🧪 **Testing**: Help test the software with different data types
...
## 👨‍💻 About Author <a id="-about-author"></a>
...
- 🐱 **GitHub**: [@AmanRathoreP](https://github.com/AmanRathoreP) | [@AmanRathoreM](https://github.com/AmanRathoreM)
...
<div align="center">
  <p><strong>🐭 ToxTrac Data Analyzer - Empowering Behavioral Research Through Advanced Analytics</strong></p>
  <p>Made with ❤️ for the neuroscience research community</p>
</div>
